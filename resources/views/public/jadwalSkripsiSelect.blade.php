<x-layouts.publicLayout>
    <x-slot name="titleHead">
        Jadwal Sidang Skripsi - {{ $thesis->name }}
    </x-slot>
                    ...
                    <div class="col-lg-7 p-4 p-md-5">
                        ...
                        <div class="mb-4">
                            <span class="badge px-3 py-2 rounded-pill mb-3" style="background-color: rgba(17, 102, 123, 0.1); color: #11667B; font-weight: 600;">
                                <i class="bi bi-person-badge me-2"></i>Identitas Peserta Sidang
                            </span>
                            <h3 class="fw-bold mb-1" style="color: #11667B">{{ $thesis->name }}</h3>
                            <p class="text-muted fs-5 mb-4">NIM: {{ $thesis->nim }}</p>
                        </div>

                        <div class="mb-4 p-4 rounded-4" style="background-color: #f8f9fa; border: 2px solid #F59F1F;">
                            <label class="text-uppercase small fw-bold text-muted mb-2 d-block" style="letter-spacing: 1px;">Judul Tugas Akhir / Skripsi</label>
                            <h5 class="fw-bold lh-base mb-0" style="color: #333;">"{{ $thesis->title }}"</h5>
                        </div>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <span class="fw-bold text-dark">{{ $thesis->supervisor }}</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mb-4">
                                <div class="d-flex align-items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <h5 class="mb-0 fw-bold">{{ \Carbon\Carbon::parse($thesis->date)->locale('id')->translatedFormat('l, d F Y') }}</h5>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        <small class="opacity-75 d-block">Waktu Sidang</small>
                                        <h5 class="mb-0 fw-bold">{{ \Carbon\Carbon::parse($thesis->date)->locale('id')->translatedFormat('H:i') }} WIB</h5>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <h5 class="mb-0 fw-bold">{{ $thesis->room }}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
