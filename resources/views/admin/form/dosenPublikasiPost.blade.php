...
<div class="container py-4">
    <x-layouts.bannerAdmin icon="bi bi-plus-square" title="Formulir Tambah Data Publikasi" subTitle="{{ $lecturer->name }}"/>
        ...
        <div class="col-12 col-lg-10">
            <div class="card bg-white shadow rounded-4 overflow-hidden">
                <div class="card-body p-4 p-lg-5">
                    ...
                    <form id="form" method="POST" action="/adminDosenPublikasi/create/{{ $lecturer->id }}">
                        @csrf
