...
<div class="container">
    <x-layouts.navbarAdmin>
        <x-slot name="mainContent">
            <x-layouts.bannerAdmin icon="bi bi-plus-square" title="Kemahasiswaan" subTitle="Formulir Tambah Seminar Kerja Praktek"/>
                ...
                <div class="col-12 col-lg-10">
                    <div class="card bg-white shadow rounded-4 overflow-hidden">
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form id="form" method="POST" action="/practices">
                                @csrf
                                ...
                                <div class="mb-4">
                                    <label class="form-label fw-bold" style="color: #11667B;">Judul Kerja Praktek <span class="text-danger">*</span></label>
                                    <textarea class="form-control bg-light border border-secondary-subtle shadow-none @error('title') is-invalid @enderror" 
                                              name="title" 
                                              rows="4" 
                                              placeholder="Tuliskan judul laporan/seminar secara lengkap..."
