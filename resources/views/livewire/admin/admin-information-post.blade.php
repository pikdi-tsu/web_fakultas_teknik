        ...
        <div>
            <div class="card bg-white shadow rounded-4 overflow-hidden">
                <div class="card-body p-4 p-lg-5">
                    ...
                    <form id="form" method="POST" action="/informations" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select bg-light border border-secondary-subtle shadow-none @error('category_id') is-invalid @enderror" 
                                        name="category_id" 
