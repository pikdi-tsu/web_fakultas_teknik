...
<div class="container">
    <x-layouts.navbarAdmin>
        <x-slot name="mainContent">
            <x-layouts.bannerAdmin icon="bi bi-pencil-square" title="Manajemen Kurikulum" subTitle="Formulir Edit Mata Kuliah"/>
                ...
                <div class="col-12 col-lg-10">
                    <div class="card bg-white shadow rounded-4 overflow-hidden">
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form id="form" action="/studies/{{ $study_id }}/subjects/{{ $subject->id }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control bg-light border border-secondary-subtle shadow-none @error('name') is-invalid @enderror" 
                                              ...
                                              style="border-radius: 10px;">{{ old('name', $subject->name) }}</textarea>
                                    @error('name')
                                ...
                                <div class="d-none">
                                    <input type="hidden" name="study_id" value="{{ old('study_id', $subject->study_id) }}">
                                    @error('study_id')
