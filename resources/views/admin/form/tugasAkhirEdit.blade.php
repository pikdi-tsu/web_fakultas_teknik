...
<div class="container">
    <x-layouts.navbarAdmin>
        <x-slot name="mainContent">
            <x-layouts.bannerAdmin icon="bi bi-pencil-square" title="Riset & Pengabdian" subTitle="Formulir Edit Tugas Akhir Mahasiswa"/>
                ...
                <div class="col-12 col-lg-10">
                    <div class="card bg-white shadow rounded-4 overflow-hidden">
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form id="form" action="/assignments/{{ $assignment->id }}" method="POST">
                                @csrf
                                @method('PUT')
                        
                                <div class="mb-4">
                                    <label class="form-label fw-bold" style="color: #11667B;">Judul Tugas Akhir <span class="text-danger">*</span></label>
                                    <input type="text" 
                                           class="form-control bg-light border border-secondary-subtle shadow-none @error('title') is-invalid @enderror" 
                                           name="title" 
                                           value="{{ old('title', $assignment->title) }}"
                                           placeholder="Tuliskan judul tugas akhir secara lengkap..."
                                ...
                                <div class="row pt-2">
                                    <div class="col-md-8 mb-4">
                                        <label class="form-label fw-bold" style="color: #11667B;">Program Studi <span class="text-danger">*</span></label>
                                        <input type="text" 
                                               class="form-control bg-light border border-secondary-subtle shadow-none @error('program') is-invalid @enderror" 
                                               name="program" 
                                               value="{{ old('program', $assignment->program) }}"
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <input type="number" 
                                               ...
                                               name="year" 
                                               value="{{ old('year', $assignment->year) }}"
                                ...
                                <div class="mb-4 border-top pt-4 mt-4" wire:ignore>
                                    ...
                                    <input id="abstraction-trix" type="hidden" name="abstraction" value="{{ old('abstraction', $assignment->abstraction) }}">
