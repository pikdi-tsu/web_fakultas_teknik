...
<div class="container">
    <x-layouts.navbarAdmin>
        <x-slot name="mainContent">
            <x-layouts.bannerAdmin icon="bi bi-plus-square" title="Manajemen Kurikulum" subTitle="Formulir Tambah CPL"/>
                ...
                <div class="col-12 col-lg-10">
                    <div class="card bg-white shadow rounded-4 overflow-hidden">
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form id="form" method="POST" action="/studies/{{ $study_id }}/cpls">
                                @csrf
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="code" 
                                           value=""
                                           placeholder="Contoh: CPL01 / PLO-01"
