...
<div class="container">
    <x-layouts.navbarAdmin>
        <x-slot name="mainContent">
            <x-layouts.bannerAdmin icon="bi bi-pencil-square" title="Riset & Pengabdian" subTitle="Formulir Edit Pengabdian Dosen"/>
                ...
                <div class="col-12 col-lg-10">
                    <div class="card bg-white shadow rounded-4 overflow-hidden">
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form id="form" action="/dedications/{{ $dedication->id }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="title" 
                                           value="{{ old('title', $dedication->title) }}"
                                ...
                                <div class="mb-4 border-bottom pb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="team" 
                                           value="{{ old('team', $dedication->team) }}"
                                ...
                                <div class="row pt-2">
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <input type="number" 
                                               ...
                                               name="year" 
                                               value="{{ old('year', $dedication->year) }}"
                                    ...
                                    <div class="col-md-8 mb-4">
                                        ...
                                        <input type="text" 
                                               ...
                                               name="fund" 
                                               value="{{ old('fund', $dedication->fund) }}"
                                ...
                                <div class="mb-4 border-top pt-4 mt-4" wire:ignore>
                                    ...
                                    <input id="abstraction-trix" type="hidden" name="abstraction" value="{{ old('abstraction', $dedication->abstraction) }}">
