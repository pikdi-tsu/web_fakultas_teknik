...
<div class="container">
    <x-layouts.navbarAdmin>
        <x-slot name="mainContent">
            <x-layouts.bannerAdmin icon="bi bi-pencil-square" title="Riset & Pengabdian" subTitle="Formulir Edit Publikasi Mahasiswa"/>
                ...
                <div class="col-12 col-lg-10">
                    <div class="card bg-white shadow rounded-4 overflow-hidden">
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form id="form" action="/publications/{{ $publication->id }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           placeholder="Tuliskan judul publikasi atau jurnal secara lengkap..."
                                ...
                                <div class="mb-4 border-bottom pb-4">
                                    <label class="form-label fw-bold" style="color: #11667B;">Tim Penulis <span class="text-danger">*</span></label>
                                    <input type="text" 
                                           class="form-control bg-light border border-secondary-subtle shadow-none @error('team') is-invalid @enderror" 
                                           name="team" 
                                           value="{{ old('team', $publication->team) }}"
                                           placeholder="Contoh: Andi (Ketua), Siti, Budi..."
                                           style="border-radius: 10px;">
                                    @error('team')
                                        <div class="invalid-feedback fw-semibold">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="row pt-2">
                                    <div class="col-md-8 mb-4">
                                        <label class="form-label fw-bold" style="color: #11667B;">Link Jurnal <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            ...
                                            <input type="url" 
                                                   ...
                                                   placeholder="Contoh: https://jurnal.kampus.ac.id/..."
                                ...
                                <div class="mb-4 border-top pt-4 mt-4" wire:ignore>
                                    ...
                                    <input id="abstraction-trix" type="hidden" name="abstraction" value="{{ old('abstraction', $publication->abstraction) }}">
